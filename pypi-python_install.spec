...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707135993
...
cp %{_builddir}/python-install-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-python_install/4339a5c41946d5ce6e23a8b8c4fff00d838d40c9 || :
